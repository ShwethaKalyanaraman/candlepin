...
public class ManifestManager {
     ...
     */
    public JobBuilder generateManifestAsync(String consumerUuid, Owner owner, String cdnLabel,
        ...
        return ExportJob.createJobBuilder(consumer, owner, cdnLabel, webUrl, apiUrl, extensionData);
    }
